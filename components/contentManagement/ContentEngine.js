...
export const ContentEngine = ({
  ...
  const loadDNSFields = async (_domain = null) => {
    ...
    let responseFields = await apiService().get(
      "/PrivateLabel/GetFields?domain=" +
        domain +
        (oemCompanyId != null ? "&companyId=" + oemCompanyId : "")
    );
      ...
      renderCell: (params) => {
        const RenderData = (row) => {
          ...
          return (
            <>
              <Box
                sx={{ fontFamily: row.value, fontSize: 20, cursor: "pointer" }}
              >
                {row.value}
              </Box>
              <link
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      let response = await apiService().get(
        "/PrivateLabel/GetEditorData?domain=" +
          oEMDomain +
          (oemCompanyId != null ? "&companyId=" + oemCompanyId : "")
      );
        ...
        <>
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              ...
              <Tab label="App Icon / Colors" {...a11yProps(3)} />
              <Tab label="Fonts" {...a11yProps(4)} />
              <Tab label="Style Sheet Editor" {...a11yProps(5)} />
              <Tab label="HTML Import Editor" {...a11yProps(6)} />
            </Tabs>
          </Box>
        </>
      )}
                    ...
                    <Grid item size={4}>
                      <Box sx={{ paddingBottom: 4 }}>
                        <Dropzone
                          image={
                            process.env.apiUri +
                            "/api/PrivateLabel/GetFavIcon?oemCompanyId=" +
                            oemCompanyId
                          }
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item size={6}>
                      ...
                      <Box sx={{ fontFamily: selectedFont }}>
                        ...
                        Sed ut ultricies odio. Nunc ut quam turpis. In hac
                        habitasse platea dictumst. Suspendisse potenti. Nullam
                        malesuada, purus id sagittis vestibulum, massa tellus
                        gravida elit, vitae ultrices tortor nulla ac nunc.
                        Aenean tempus semper est vel convallis. Sed feugiat,
                        risus eu tincidunt eleifend, purus metus vulputate
                        nulla, et condimentum sapien erat in nisi. Nunc non
                        malesuada libero. Donec tempus tincidunt mi at
                        vulputate. Vestibulum ante ipsum primis in faucibus orci
                        luctus et ultrices posuere cubilia Curae; Suspendisse
                        potenti. Etiam nec eleifend orci. Suspendisse in est vel
                        nunc rhoncus bibendum vitae id felis. Integer bibendum
                        dolor elit, at tincidunt lacus tempor ac. Maecenas
                        lobortis, mauris at condimentum feugiat, nulla orci
                        condimentum massa, sed facilisis tellus ligula vitae
                        metus. Aliquam erat volutpat. Quisque dignissim felis
                        augue, at semper nisl posuere ut. Proin fringilla diam
                        vitae faucibus finibus.
                        <br />
                        <br />
                        Aenean tempus semper est vel convallis. Sed feugiat,
                        risus eu tincidunt eleifend, purus metus vulputate
          ...
          <Box>
            <Grid container spacing={2}>
              <Grid item size={6}>
                ...
                <small>
                  You can add imports such as google analytics or clarity
                </small>
              </Grid>
              <Grid item size={6} sx={{ textAlign: "right" }}>
                <Button
            ...
            <Box sx={{ paddingTop: 1 }}>
              {data != null && (
                <Editor
                  ...
                  theme="vs-dark"
                  defaultValue={
                    data == null || data.prettyHTML == null
                      ? ""
                      : data.prettyHTML
                  }
                />
